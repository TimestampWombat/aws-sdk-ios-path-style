Pod::Spec.new do |s|
  ...
  s.subspec 'AWSCognitoIdentityProvider' do |sub|
    sub.dependency 'AWSCognitoIdentityProvider', '9.9.9'
  end

  # Used by all service-api subspecs
  s.subspec 'AWSCore' do |sub|
    sub.dependency 'AWSCore', '9.9.9'
  end

  # Service-api subspecs
  s.subspec 'AWSAPIGateway' do |sub|
    sub.dependency 'AWSAPIGateway', '9.9.9'
  end

  s.subspec 'AutoScaling' do |sub|
    sub.dependency 'AWSAutoScaling', '9.9.9'
  end

  s.subspec 'CloudWatch' do |sub|
    sub.dependency 'AWSCloudWatch', '9.9.9'
  end

  s.subspec 'AWSComprehend' do |sub|
    sub.dependency 'AWSComprehend', '9.9.9'
  end

  s.subspec 'AWSConnect' do |sub|
    sub.dependency 'AWSConnect', '9.9.9'
  end

  s.subspec 'AWSConnectParticipant' do |sub|
    sub.dependency 'AWSConnectParticipant', '9.9.9'
  end

  s.subspec 'DynamoDB' do |sub|
    sub.dependency 'AWSDynamoDB', '9.9.9'
  end

  s.subspec 'EC2' do |sub|
    sub.dependency 'AWSEC2', '9.9.9'
  end

  s.subspec 'ElasticLoadBalancing' do |sub|
    sub.dependency 'AWSElasticLoadBalancing', '9.9.9'
  end

  s.subspec 'AWSIoT' do |sub|
    sub.dependency 'AWSIoT', '9.9.9'
  end

  s.subspec 'AWSKMS' do |sub|
    sub.dependency 'AWSKMS', '9.9.9'
  end

  s.subspec 'Kinesis' do |sub|
    sub.dependency 'AWSKinesis', '9.9.9'
  end
  ...
  s.subspec 'KinesisVideoSignaling' do |sub|
    sub.dependency 'AWSKinesisVideoSignaling', '9.9.9'
  end

  s.subspec 'AWSLambda' do |sub|
    sub.dependency 'AWSLambda', '9.9.9'
  end

  s.subspec 'AWSLex' do |sub|
    sub.dependency 'AWSLex', '9.9.9'
  end

  s.subspec 'AWSLogs' do |sub|
    sub.dependency 'AWSLogs', '9.9.9'
  end

  s.subspec 'AWSMachineLearning' do |sub|
    sub.dependency 'AWSMachineLearning', '9.9.9'
  end

  s.subspec 'Pinpoint' do |sub|
    sub.dependency 'AWSPinpoint', '9.9.9'
  end

  s.subspec 'AWSPolly' do |sub|
    sub.dependency 'AWSPolly', '9.9.9'
  end

  s.subspec 'AWSRekognition' do |sub|
    sub.dependency 'AWSRekognition', '9.9.9'
  end

  s.subspec 'AWSS3' do |sub|
    sub.dependency 'AWSS3', '9.9.9'
  end

  s.subspec 'AWSSES' do |sub|
    sub.dependency 'AWSSES', '9.9.9'
  end

  s.subspec 'AWSSNS' do |sub|
    sub.dependency 'AWSSNS', '9.9.9'
  end

  s.subspec 'AWSSQS' do |sub|
    sub.dependency 'AWSSQS', '9.9.9'
  end
  
  s.subspec 'AWSSageMakerRuntime' do |sub|
    sub.dependency 'AWSSageMakerRuntime', '9.9.9'
  end

  s.subspec 'AWSSimpleDB' do |sub|
    sub.dependency 'AWSSimpleDB', '9.9.9'
  end

  s.subspec 'AWSTextract' do |sub|
    sub.dependency 'AWSTextract', '9.9.9'
  end
  
  s.subspec 'AWSTranscribe' do |sub|
    sub.dependency 'AWSTranscribe', '9.9.9'
  end
  ...
  s.subspec 'AWSTranslate' do |sub|
    sub.dependency 'AWSTranslate', '9.9.9'
  end
